...
namespace Sample
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			resources.ApplyResources(this._grpProgram, "_grpProgram");
			this._grpProgram.Name = "_grpProgram";
			this._grpProgram.TabStop = false;
			// 
			// _btnUploadProgram
			// 
			resources.ApplyResources(this._btnUploadProgram, "_btnUploadProgram");
			this._btnUploadProgram.Name = "_btnUploadProgram";
			this._btnUploadProgram.UseVisualStyleBackColor = true;
			this._btnUploadProgram.Click += new System.EventHandler(this._btnUploadProgram_Click);
			// 
			// _btnDownloadProgram
			// 
			resources.ApplyResources(this._btnDownloadProgram, "_btnDownloadProgram");
			this._btnDownloadProgram.Name = "_btnDownloadProgram";
			this._btnDownloadProgram.UseVisualStyleBackColor = true;
			this._btnDownloadProgram.Click += new System.EventHandler(this._btnDownloadProgram_Click);
			// 
			// _btnReferenceProgramFilePath
			// 
			resources.ApplyResources(this._btnReferenceProgramFilePath, "_btnReferenceProgramFilePath");
			...
			this._btnReferenceProgramFilePath.Click += new System.EventHandler(this._btnReferenceProgramFilePath_Click);
			// 
			// _txtProgramFilePath
			// 
			resources.ApplyResources(this._txtProgramFilePath, "_txtProgramFilePath");
			this._txtProgramFilePath.Name = "_txtProgramFilePath";
			// 
			// _lblSelectProgram
			// 
			resources.ApplyResources(this._lblSelectProgram, "_lblSelectProgram");
            ...
            resources.GetString("_cbxSelectProgram.Items"),
            resources.GetString("_cbxSelectProgram.Items1"),
            resources.GetString("_cbxSelectProgram.Items2"),
            resources.GetString("_cbxSelectProgram.Items3"),
            resources.GetString("_cbxSelectProgram.Items4"),
            resources.GetString("_cbxSelectProgram.Items5"),
            resources.GetString("_cbxSelectProgram.Items6"),
            resources.GetString("_cbxSelectProgram.Items7"),
            resources.GetString("_cbxSelectProgram.Items8"),
            resources.GetString("_cbxSelectProgram.Items9"),
            resources.GetString("_cbxSelectProgram.Items10"),
            resources.GetString("_cbxSelectProgram.Items11"),
            resources.GetString("_cbxSelectProgram.Items12"),
            resources.GetString("_cbxSelectProgram.Items13"),
            resources.GetString("_cbxSelectProgram.Items14"),
            resources.GetString("_cbxSelectProgram.Items15"),
            resources.GetString("_cbxSelectProgram.Items16"),
            resources.GetString("_cbxSelectProgram.Items17")});
			resources.ApplyResources(this._cbxSelectProgram, "_cbxSelectProgram");
			this._cbxSelectProgram.Name = "_cbxSelectProgram";
			// 
			// _openProgramFileDialog
			// 
			this._openProgramFileDialog.CheckFileExists = false;
			this._openProgramFileDialog.DefaultExt = "bin";
			resources.ApplyResources(this._openProgramFileDialog, "_openProgramFileDialog");
			// 
			// MainForm
			// 
			resources.ApplyResources(this, "$this");
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this._grpProgram);
